...
int main()
{
    ...
    // ********************************** TEXTURAS **************************************************
    Texture2D tortuga[2];
    tortuga[0]= LoadTexture("texturas/tortuga_izq.png");
    Rectangle framesTortuga = {0.0f, 0.0f, (float)tortuga[0].width / 6, (float)tortuga[0].height};

    tortuga[1] = LoadTexture("texturas/tortuga_der.png");
    Rectangle framesTortugaizq = {0.0f, 0.0f, (float)tortuga[1].width / 6, (float)tortuga[1].height};
